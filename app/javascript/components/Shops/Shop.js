    ...
    <div className="card" style={{width: 100 + '%'}}>
      <img src={props.attributes.image_url} alt={props.attributes.name} className="card-img-top"/>
        <div className="card-body">
          ...
          <a href={`${props.attributes.website}`} target="_blank" className="btn btn-secondary">Website</a>
          <Link className="btn btn-primary" to={`/shops/${props.attributes.id}`}>View Shop</Link>
        </div>
    </div>
    // <Card>
